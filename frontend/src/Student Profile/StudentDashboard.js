        ...
        return (
          <div style={styles.dashboardContent}>
            <div style={styles.headerRow}>
                <h2 style={styles.shiftHeader}>My Student Dashboard</h2>
            ...
            <div style={styles.quickAccessRow}>
              <div style={styles.quickAccessContainer}>
                ...
                <div style={styles.quickAccessGrid}>
                  <button style={styles.quickButton}>Join Class</button>
                </div>
              </div>
            </div>
    ...
    <div style={styles.container}>
      <div style={styles.sidebar}>
        ...
        <div style={styles.navButtons}>
          {['Dashboard', 'Calendar', 'Class Resources'].map((item) => (
            <div
              key={item}
              style={{
                ...styles.navButton,
            ...
            >
              <span style={styles.icon}>{
                ...
                item === 'Class Resources' ? <FaEllipsisH /> :
                <FaUsers />
              }</span>
              {item}
            </div>
